...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8c86153a037d96505a27435622e0e78866826a747ce84899910fcda567870ce1.js',function(){input.required=false;search();});}
