...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6704476722949da2cad4435223291083c56b0b279e299048b0ba1126f154a0c9.js',function(){input.required=false;search();});}
