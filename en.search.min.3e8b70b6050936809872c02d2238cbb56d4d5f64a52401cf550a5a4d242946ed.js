...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.989bf28eeef7777408354a2c9b563771cf97807f5b43a3d88f7f90ff0bd96267.js',function(){input.required=false;search();});}
