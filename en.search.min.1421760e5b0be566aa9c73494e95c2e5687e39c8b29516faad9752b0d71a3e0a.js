...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a1ef860074c31393d738e8e99f22d7c351a58b4576428cd2e0190911a779109a.js',function(){input.required=false;search();});}
