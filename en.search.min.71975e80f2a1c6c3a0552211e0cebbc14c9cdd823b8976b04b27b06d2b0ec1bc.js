...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.da3f726bf074281a954bda3fa666da0053f197a683ec69dfeb9a2c3166300ae0.js',function(){input.required=false;search();});}
