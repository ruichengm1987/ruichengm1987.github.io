...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.26e64340e21f561dcf0d6664dd754d8370d54fac251a8cb44bd1c22687df8b25.js',function(){input.required=false;search();});}
