...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e69277138d51a04690227d8d4b1f2a61a87751659afd5eebf8ca191fae2487d3.js',function(){input.required=false;search();});}
