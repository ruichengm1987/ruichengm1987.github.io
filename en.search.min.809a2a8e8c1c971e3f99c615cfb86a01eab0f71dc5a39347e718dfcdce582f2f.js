...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a7ce66a07e68bd682397e037b70903380fe11a02b96c97c7553a4bd76f07db2e.js',function(){input.required=false;search();});}
