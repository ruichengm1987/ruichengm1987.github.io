...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e3abfb7d758e4d7b8b03afd9895fd3ea1ae150ed5396d8d0ba2e01c1f6dd523e.js',function(){input.required=false;search();});}
