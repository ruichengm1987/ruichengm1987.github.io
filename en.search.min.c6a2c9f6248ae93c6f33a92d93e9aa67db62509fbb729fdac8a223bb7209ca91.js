...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7434435d4a80fcaf2573dab796fb8f402b547a0ba048fd2549e620544ebe94c0.js',function(){input.required=false;search();});}
