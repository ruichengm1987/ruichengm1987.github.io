...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.aeec0eb311f566ae30a108426061a32ed2976377c4774f52c06a39f2d3fa6952.js',function(){input.required=false;search();});}
