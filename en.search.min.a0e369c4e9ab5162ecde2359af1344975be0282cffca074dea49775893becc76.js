...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b7f70d07220226a8be6bad2f09ad678370a1eb4982522ca5bd4e87a2da169719.js',function(){input.required=false;search();});}
