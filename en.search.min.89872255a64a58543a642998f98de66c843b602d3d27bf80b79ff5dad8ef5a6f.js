...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.16429e9e40dfdb331d8a13acac880abf5b01e945d40ff935caa469433fa4ac1e.js',function(){input.required=false;search();});}
