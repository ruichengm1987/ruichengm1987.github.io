...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c262faa972367622643ee84525326886a9c66b78c3d32b9966830efe47dd4e57.js',function(){input.required=false;search();});}
